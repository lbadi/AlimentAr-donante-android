...
public enum  NotificationType {
    ...
    DONATION_EXPIRED("donation_expired", R.string.notifiaction_activated_title),
    ACTIVATION_TIME_PASSED("activation_time_passed", R.string.notifiaction_activated_title),;
