...
public class DatePickerFragment extends DialogFragment
    ...
    public static DatePickerFragment newInstance(OnSelectedDateCallBack onSelectedDateCallBack){
        DatePickerFragment fragment = new DatePickerFragment();
        fragment.onSelectedDateCallBack = onSelectedDateCallBack;
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        if (onSelectedDateCallBack != null) {
            onSelectedDateCallBack.onSelectedDate(year, month, day);
        }
    }
